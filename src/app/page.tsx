...
<div className="max-w-2xl">
            ...
            <div className="flex flex-wrap gap-4">
              <Link
                href="/catalogo"
                className="inline-flex items-center gap-2 bg-[var(--accent)] text-white px-8 py-4 rounded-xl font-medium transition-all duration-200 hover:bg-[var(--accent-hover)] hover:shadow-lg active:scale-[0.98]"
              >
                Ver Catálogo
                <svg
              ...
              <a
                href="https://wa.me/56978953903"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 text-white px-8 py-4 rounded-xl font-medium transition-all duration-200 hover:bg-white/20 active:scale-[0.98]"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
